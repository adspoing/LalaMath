...
class ProblemList extends React.Component {
    ...
    render() {
        ...
        for(var i=0;i<Data[this.props.problemIndex].fields.twinproblems.length;i++){
            ...
            twinOption.push(<Option key={iddd+""} value={Data[this.props.problemIndex].fields.twinproblems[i]}>{iddd.toString()}</Option>)
        }
        var recommendOption=[];
        if(Data[this.props.problemIndex].fields.answer==selvalue){
            ...
            var iddd=AllData[indexx].fields.code;
            recommendOption.push(<Option key={iddd+""} value={Data[this.props.problemIndex].fields.rightproblems[i]}>{iddd.toString()}</Option>)
            }
        }
        else{
            ...
            var iddd=AllData[indexx].fields.code;
            recommendOption.push(<Option key={iddd+""} value={Data[this.props.problemIndex].fields.wrongproblems[i]}>{iddd.toString()}</Option>)
            }
        }
